module SlangerHelperMethods
  def start_slanger_with_options options={}
    ...
    @server_pid = EM.fork_reactor do
      ...
      opts = { host:             '0.0.0.0',
               api_port:         '4567',
               websocket_port:   '8181',
               app_key:          'f23fou402gh7ezono99',
               secret:           '592zxq4g45gg36nopi775ddh',
  ...
  def new_websocket opts = {}
    ...
    uri = "ws://0.0.0.0:8181/app/#{opts[:key]}?client=js&version=1.8.5&protocol=#{opts[:protocol]}"
