# -*- encoding: utf-8 -*-
# stub: meta_request 0.6.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<railties>, ["< 6", ">= 3.0.0"])
      s.add_runtime_dependency(%q<rack-contrib>, ["< 3", ">= 1.1"])
      s.add_runtime_dependency(%q<callsite>, [">= 0.0.11", "~> 0.0"])
    else
      s.add_dependency(%q<railties>, ["< 6", ">= 3.0.0"])
      s.add_dependency(%q<rack-contrib>, ["< 3", ">= 1.1"])
