...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<capybara>, ["< 4", ">= 2.1"])
      ...
      s.add_development_dependency(%q<sinatra>, ["<= 3.0"])
      s.add_development_dependency(%q<rake>, [">= 0"])
      s.add_development_dependency(%q<image_size>, ["~> 1.0"])
      s.add_development_dependency(%q<pdf-reader>, ["< 3.0", ">= 1.3.3"])
      ...
      s.add_dependency(%q<capybara>, ["< 4", ">= 2.1"])
      ...
      s.add_dependency(%q<sinatra>, ["<= 3.0"])
      s.add_dependency(%q<rake>, [">= 0"])
      s.add_dependency(%q<image_size>, ["~> 1.0"])
      s.add_dependency(%q<pdf-reader>, ["< 3.0", ">= 1.3.3"])
